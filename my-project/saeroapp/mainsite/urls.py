...
urlpatterns = [
    ...
    path("about/<slug:slug>",views.manageteam_details,name="manageteam-detail"), #bunun olayı site adresi base ise ne olcağını söylüyoruz. Hiç bir şey olmamasının anlamı bu --http://127.0.0.1:8000/
